...
public class RunKtimesForEffectSizeTest {
	...
	public static void main(String[] args) throws IOException {
		...
		// String root =
		// "G:\\research\\tag_recommendation\\folksonomy\\StackOverFlowForShaowei\\";
		// String root
		// ="F:\\shaowei\\research\\tag_recommendation\\folksonomy\\StackOverFlowForShaowei\\";
		String inputData = root + "dataset.csv";
		
		
		BufferedWriter bwRepeat = new BufferedWriter(new FileWriter(root+"repeat_precision_recall.csv"));
				...
				returnTopK = returnK;
					...
					try {
						for (int i = 0; i < crossNumber; i++) {
							...
							double[] paras = crossValidation.trainTwoParameters(
