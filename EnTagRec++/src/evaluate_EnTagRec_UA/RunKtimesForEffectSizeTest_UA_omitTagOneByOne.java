...
public class RunKtimesForEffectSizeTest_UA_omitTagOneByOne {
	...
	static boolean useAddiionalTags = false;
	...
	public static void main(String[] args) throws IOException {
		...
		for (int repeatI = 2; repeatI < repeatN; repeatI++) {
						...
						try {
							for (int i = 0; i < crossNumber; i++) {
								...
								HashMap<String, List<String>> exclusiveTags = InferenceWithAssocRules
										.getExclusiveTags(goldenSet, givenTagN,repeatI);
								;
								if (useAddiionalTags) {
